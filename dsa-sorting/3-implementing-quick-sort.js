function qSort(array, start = 0, end = array.length) {
    ...
    leftArray = qSort(array, start, middle);    
    rightArray = qSort(array, middle + 1, end);
    return array;
};

// In-place partitions, that means no slicing!
...
// Element j in the array swaps with element i
// array[i], array[j] to array[j], array[i]
